...
Static site that plays back a pre-rendered race. No server, no Python needed at runtime — everything ships in `web/data/*.json`.
...
2. In repo Settings → Pages, set source to `main` branch and folder to `/web`.
